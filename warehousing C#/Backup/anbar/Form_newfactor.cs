...
namespace anbar
{
    public partial class Form_newfactor : Form
    {
        ...
        void show()
        {
            ...
            textBoxX5.DataBindings.Add("text", dt, "cter");
        }
        private void comboBoxEx4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            textBoxX5.DataBindings.Clear();
            textBoxX5.DataBindings.Add("text", dt5, "cter");
            ...
            textBoxX3.DataBindings.Add("text", dt7, "id");
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                textBoxX3.DataBindings.Clear();
                textBoxX3.DataBindings.Add("text", dt, "id");
                int t = 0;
